<template><div><h1 id="_3-2-订单回调" tabindex="-1"><a class="header-anchor" href="#_3-2-订单回调"><span>3.2 订单回调</span></a></h1>
...
<td style="text-align:left">string(16)</td>
<td style="text-align:left">代付订单状态，<code v-pre>1=提现中,2=提现成功，3=拒绝提现，4=转账异常</code></td>
</tr>
<tr>
...
<div class="custom-container tip"><p class="custom-container-title">说明</p>
<p>商户也可在后台 <code v-pre>商户代付</code> 页面，动手触发 <code v-pre>回调通知</code>。</p>
</div>
</div></template>
