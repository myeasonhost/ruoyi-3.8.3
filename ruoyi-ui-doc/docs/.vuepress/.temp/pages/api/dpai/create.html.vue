<template><div><h1 id="_3-1-订单创建" tabindex="-1"><a class="header-anchor" href="#_3-1-订单创建"><span>3.1 订单创建</span></a></h1>
<div class="custom-container tip"><p class="custom-container-title">说明</p>
<p>（1）提现出U自动回调下分，在提现成功后，系统将即时进行 <code v-pre>回调通知</code>。<br>
...
<td style="text-align:left">必填</td>
<td style="text-align:left">string(64)</td>
<td style="text-align:left">用户收款的钱包地址。</td>
</tr>
<tr>
...
<code v-pre>sign</code> 的生成规则为：<code v-pre>toLowerCase(md5(mch_id + amount + currency + coin_code + order_id + product_name + customer_id + notify_url + address + api key))</code>。</p>
</div>
...
<td style="text-align:left">用户收款地址</td>
<td style="text-align:left">string(64)</td>
<td style="text-align:left">接收用户支付的地址，以字母 <code v-pre>T</code> 开头。</td>
</tr>
<tr>
<td style="text-align:left">out_address</td>
<td style="text-align:left">商户转出地址</td>
<td style="text-align:left">string(64)</td>
<td style="text-align:left">商户支付的地址，以字母 <code v-pre>T</code> 开头。</td>
</tr>
</tbody>
</table>
<p>请求示例：</p>
