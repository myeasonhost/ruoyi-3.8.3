<template><div><h1 id="账户余额查询" tabindex="-1"><a class="header-anchor" href="#账户余额查询"><span>账户余额查询</span></a></h1>
<div class="custom-container tip"><p class="custom-container-title">说明</p>
<p>商户可调用该接口，查询账户余额信息。</p>
</div>
<h2 id="接口地址" tabindex="-1"><a class="header-anchor" href="#接口地址"><span>接口地址</span></a></h2>
<div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="line">GET https://pro.tronapi.com/api/account/balance</span>
...
<span class="line">    <span class="token property">"data"</span><span class="token operator">:</span> <span class="token string">"200.12"</span><span class="token punctuation">,</span></span>
