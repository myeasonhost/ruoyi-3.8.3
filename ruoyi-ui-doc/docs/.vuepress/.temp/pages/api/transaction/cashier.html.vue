...
<span class="token punctuation">}</span>
</code></pre></div><p>商户可直接从上述返回数据中，取出 <code v-pre>cashier_url</code> 字段，然后跳转至该地址供用户支付。</p>
...
<div class="language-bash" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>GET redirect_url（商户在订单创建接口中指定）
</code></pre></div><h3 id="跳转参数" tabindex="-1"><a class="header-anchor" href="#跳转参数"><span>跳转参数</span></a></h3>
<table>
<thead>
<tr>
