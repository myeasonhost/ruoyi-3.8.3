<template><div><h1 id="收款地址生成" tabindex="-1"><a class="header-anchor" href="#收款地址生成"><span>收款地址生成</span></a></h1>
<div class="custom-container tip"><p class="custom-container-title">说明</p>
<p>商户可调用该接口，生成一个全新未使用的波场钱包地址。该操作不会替换当前已启用的收款地址。</p>
</div>
<div class="custom-container warning"><p class="custom-container-title">注意</p>
<p>该接口返回的数据是一次性的，平台不会存储任何内容。</p>
</div>
